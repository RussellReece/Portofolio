...
export default async function Home({ params }: { params: { lang: 'en' | 'id' } }) {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-[#ededed] font-[family-name:var(--font-geist-sans)] selection:bg-primary/30 transition-colors duration-300">
