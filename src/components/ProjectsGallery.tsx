          ...
          {filteredProjects.map((project) => (
            <div key={project.id} className="glass rounded-2xl overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="p-6 relative z-20 -mt-8">
                <span className="inline-block px-3 py-1 bg-white dark:bg-gray-900 text-xs font-semibold rounded-full border border-gray-200 dark:border-gray-700 mb-3 text-primary">
                  {project.category}
                </span>
